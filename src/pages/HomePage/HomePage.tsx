        ...
        <div className={s.container}>
            <div className={s.mainTextContainer}>
                <div className={s.secondaryTextContainer}>
                    ...
                    <p>
                        We help you to reveal your potential, overcome
                        challenges and find a guide in your own life with the
                        help of our experienced psychologists.
                    </p>
                </div>
                <Link className={s.getStartedLink} to="/psychologists">
                    Get started{' '}
                    <TfiArrowTopRight className={s.getStartedLinkIcon} />
                </Link>
            </div>
            <div className={s.wrapperRightCont}>
                <div className={s.rightContainer}>
                    <img
                        className={s.mainImg}
                        loading="lazy"
                        src={photo}
                        alt="a woman psychologist with glasses"
                    />
