    ...
    >
      ...
      <div>
        <div className="flex justify-between mb-6 flex-wrap">
          <div>
            <p className="text-[#8A8A89] text-base mb-2">Psychologist</p>
          ...
          <div className="flex gap-7 align-baseline">
            ...
            <button className="p-0 cursor-pointer">
              <HiOutlineHeart className={`w-[26px] h-[26px]`} />
            </button>
          </div>
        </div>
        ...
        >
          <li className="rounded-[24px] px-[16px] py-[8px] bg-[#F3F3F3]">
            <p className="text-[#8A8A89] text-base">
              Experience:
              <span className="text-[#191A15]">{psychologist.experience}</span>
            </p>
          </li>
          <li className="rounded-[24px] px-[16px] py-[8px] bg-[#F3F3F3]">
            <p className="text-[#8A8A89] text-base">
              License:
              <span className="text-[#191A15]">{psychologist.license}</span>
            </p>
          </li>
          <li className="rounded-[24px] px-[16px] py-[8px] bg-[#F3F3F3]">
            <p className="text-[#8A8A89] text-base">
        ...
        {isReviewsOpen && (
          <>
            ...
            <button className={s.btnAppointment}>Make an appointment</button>
          </>
        )}
